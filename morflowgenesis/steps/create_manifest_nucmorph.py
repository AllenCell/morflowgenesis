...
def create_manifest(
    ...
    for obj in tqdm.tqdm(image_objects, desc="Loading single cell features..."):
        ...
        cells = obj.load_step(single_cell_step)[['CellId', 'roi', 'scale_micron', 'centroid_z', 'centroid_y', 'centroid_x', 'label_img', '20x_lamin_path', 'nuc_seg_path', 'crop_raw_id', 'crop_raw_path', 'crop_seg_id', 'crop_seg_path']]
