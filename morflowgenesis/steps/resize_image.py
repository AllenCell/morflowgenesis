...
@task
def run_resize_task(image_object, step_name, output_name, input_step, output_shape = None, scale=None, order = 0):
    # skip if already run
...
@flow
def run_resize(image_object, step_name, output_name, input_step, output_shape = None, scale=None, order = 0):
    run_resize_task(image_object, step_name, output_name, input_step, output_shape = output_shape, scale=scale, order = order)
