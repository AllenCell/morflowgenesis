...
from aics_shape_modes.projection import compute_pca_on_reps, write_all_shape_modes_latent_walk
...
def make_shape_space(
    ...
    for seg_name in segmentation_names:
        ...
        pca, axes, sm_df = compute_pca_on_reps(shcoeffs, projection_method="PCA", n_shapemodes = n_pcs, kernel_choice=None, kernel_gamma=None)

        write_all_shape_modes_latent_walk(shape_modes_df=sm_df, 
            pca=pca, 
