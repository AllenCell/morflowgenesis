...
def generate_objects(image_objects, working_dir, step_name, csv_path, source_column, non_source_columns,metadata_column=None):
    """
    ...
    for row in df.itertuples():
        ...
        if row[source_column] not in already_run:
            new_image_objects.append(generate_object.submit(row, working_dir, step_name, source_column, non_source_columns, metadata_column))
